...
- Docker guide (details on image, ports, and env): [/docs/installation/docker](/docs/installation/docker)
‑ Image: `reaparr/reaparr:latest` (or `dev`)
‑ Default Web UI: port `7000`
