...
description: This guide will show you how to run Reaparr with Docker on any OS (Linux, Windows, macOS). Follow the steps to get Reaparr up and running in a Docker container.
---
