...
After logging in, you will automatically be guided through a setup wizard to connect your Plex account and configure your download settings. Follow the on-screen instructions to complete the setup.

![Setup Wizard](/img/screenshots/demo-2-setup-1.avif "Reaparr Setup Wizard")
